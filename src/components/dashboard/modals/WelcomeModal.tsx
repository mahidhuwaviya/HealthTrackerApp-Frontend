...
export const WelcomeModal = ({ isOpen, onClose, onStartSetup }: WelcomeModalProps) => {
    ...
    return (
        <div className="fixed inset-0 z-[60] flex items-center justify-center p-4">
            ...
            {/* Modal Content */}
            <div className="relative w-[90%] sm:w-[450px] max-w-[450px] bg-card rounded-3xl shadow-2xl p-6 md:p-12 animate-in fade-in zoom-in-95 duration-300 border border-border/50 max-h-[90dvh] overflow-y-auto custom-scrollbar">
